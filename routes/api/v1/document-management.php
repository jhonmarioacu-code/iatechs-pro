...
Route::prefix('document-management')
    ...
    ->group(function () {
        Route::get('/', [ManagedDocumentController::class, 'index'])
            ->middleware('permission:document-management.view')
            ->name('index');

        Route::post('/', [ManagedDocumentController::class, 'store'])
            ->middleware('permission:document-management.create')
            ->name('store');
        ...
        Route::put('/{managedDocument}', [ManagedDocumentController::class, 'update'])
            ->middleware('permission:document-management.update')
            ->name('update');

        Route::delete('/{managedDocument}', [ManagedDocumentController::class, 'destroy'])
            ->middleware('permission:document-management.delete')
            ->name('destroy');
    });
