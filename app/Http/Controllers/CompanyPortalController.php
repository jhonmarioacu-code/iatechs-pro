...
class CompanyPortalController extends Controller
{
    public function dashboard(Request $request): View
    {
        ...
        return view('portals.company.dashboard', [
            ...
            'kpis' => [
                ['label' => 'Tickets aprobados', 'value' => (string) $approvedCount, 'trend' => 'Flujo operativo'],
                ['label' => 'Tickets pendientes', 'value' => (string) $pendingCount, 'trend' => 'Flujo operativo'],
                ['label' => 'Tickets finalizados', 'value' => (string) $finalizedCount, 'trend' => 'Flujo operativo'],
                ['label' => 'Tickets no concretados', 'value' => (string) $notCompletedCount, 'trend' => 'Flujo operativo'],
            ],
